...
const ProjectDetailHero: React.FC<ProjectDetailHeroProps> = ({
    ...
    return (
        ...
        <div className="flex flex-col items-center text-center">
            <motion.h1
                className="text-2xl md:text-3xl lg:text-4xl font-extrabold text-gray-900 dark:text-gray-200 mb-4 md:mb-6"
            ...
            <motion.p
                className="text-gray-800 dark:text-gray-200 text-md md:text-lg leading-relaxed mb-6 md:mb-8 max-w-3xl"
