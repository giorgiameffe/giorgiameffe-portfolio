        ...
        text-center md:text-left overflow-hidden opacity-0 animate-fadeIn">
            ...
            <div className="max-w-md relative z-10">
                ...
                <div className="flex flex-wrap justify-center md:justify-start items-center gap-1 mt-4 hidden lg:flex">
                    ...
                    {/* JavaScript (JS) */}
                    <span className="flex items-center space-x-1 px-3 py-1 rounded-full text-gray-900 dark:text-gray-200 text-xs border border-gray-900 dark:border-gray-600">
                        <span>TS</span>
                    </span>
